...
public class GeneratorClient implements Client {

    private AttributeCompareRuleController attributeCompareRuleController = AttributeCompareRuleController.getInstance();
    private Socket socket = null;

    public GeneratorClient(String address, int port, TransportRule transportRule, AttributeCompareRuleController attributeCompareRuleController)  throws NullPointerException {
